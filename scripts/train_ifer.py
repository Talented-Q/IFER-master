...
from ifer import ifer_model
from tensorboardx import TensorboardLogger
import pdb
try:
...
parser.add_argument('-c', '--config', default=r'/home/cyq/Codes/Mjw/IFER/configs/ifer.yml', type=str, metavar='FILE',
...
parser.add_argument('--data_dir', default=r'/home/cyq/Dataset/RAF-DB', metavar='DIR',
...
parser.add_argument('--ckpt_asit', default='/home/cyq/Codes/Mjw/IFER/experiment/checkpoints/best_model1.pt', type=str)
# Model parameters
group = parser.add_argument_group('Model parameters')
group.add_argument('--model', default='gc_vit_base', type=str, metavar='MODEL',
...
group.add_argument('--num-classes', type=int, default=7, metavar='N',
...
group.add_argument('-b', '--batch-size', type=int, default=16, metavar='N',
                    help='Input batch size for training (default: 16 per gpu)')
...
def main():
    ...
    model = ifer_model(checkpoint_path=args.ckpt_asit, num_features=512, num_classes=7)
