...
class TrainOptions:
	...
	def initialize(self):
		self.parser.add_argument('--exp_dir', default=r'.\experiment', type=str, help='Path to experiment output directory')
		...
		self.parser.add_argument('--use_struct', default=True, type=bool, help='use structure code or not')
		...
		self.parser.add_argument('--g_labmbda', default=0.0001, type=float, help='g loss multiplier factor')
		self.parser.add_argument('--distribute_lambda', default=0.01, type=float, help='feature match loss multiplier factor')
